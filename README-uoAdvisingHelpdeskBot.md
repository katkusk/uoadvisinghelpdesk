# UO Advising Helpdesk Bot - `uoAdvisingHelpdeskBot`
...
3. Give the bot a handle (ex: `uoAdvisingHelpdeskBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://uoadvisinghelpdesk.azurewebsites.net/api/messages`
